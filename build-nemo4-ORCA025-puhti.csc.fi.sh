...
./makenemo -j 8 -m ${compiler}-puhti.csc.fi -d "OCE ICE" -r ORCA2_ICE_PISCES -n MY_ORCA025_ICE del_key "key_top"
...
cp -p $PROJAPPL/$USER/nemoatpuhti/namelist_cfg.orca025 namelist_cfg
cp -p $PROJAPPL/$USER/nemoatpuhti/nemorun_orca025.sh .
